...
interface PlatformIconProps extends Omit<SVGProps<SVGSVGElement>, "viewBox" | "fill"> {
  platform: Platform;
  size?: number;
}
...
/** Shared brand mark for Android/Windows, used everywhere a platform is represented so the two never drift out of sync. */
export function PlatformIcon({ platform, size = 24, ...props }: PlatformIconProps) {
  return (
